...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move THUNDERPUNCH, EFFECT_PARALYZE_HIT,       75, ELECTRIC,     	SPECIAL,	100, 15,  10
	...
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC_TYPE, 	PHYSICAL,	100, 25,  10
	...
	move RAIN_DANCE,   EFFECT_RAIN_DANCE,          0, WATER,        	PHYSICAL,	 90,  5,   0
