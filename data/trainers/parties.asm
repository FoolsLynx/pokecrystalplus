...
FalknerGroup:
	...
	db  10, HOOTHOOT
		db	NO_ITEM
		db	TACKLE, FORESIGHT, PECK, NO_MOVE
	db	10, PIDGEOTTO
		db	NO_ITEM
		db	TACKLE, MUD_SLAP, GUST, NO_MOVE
	db  12, MURKROW
		db  SHARP_BEAK
		db	PECK, PURSUIT, MUD_SLAP, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 23, FURRET
		db	NO_ITEM
		db	DEFENSE_CURL, FURY_SWIPES, ENDURE,	RETURN
	db 24, TEDDIURSA
		db	PINK_BOW
		db	FURY_SWIPES, FAINT_ATTACK, REST, SNORE
	db 26, MILTANK
		db	NO_ITEM
...
BugsyGroup:
	...
	db 18, LEDYBA
		db 	NO_ITEM
		db	TACKLE, SUPERSONIC, COMET_PUNCH, NO_MOVE
	db 18, SPINARAK
		db 	NO_ITEM
		db	POISON_STING, STRING_SHOT, NIGHT_SHADE, NO_MOVE
	db 19, YANMA
		db	NO_ITEM
		db	QUICK_ATTACK, DOUBLE_TEAM, SONICBOOM, NO_MOVE
	db 20, SCYTHER
		db 	SILVERPOWDER
