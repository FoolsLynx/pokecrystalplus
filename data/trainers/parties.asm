...
FalknerGroup:
	...
	db  10, HOOTHOOT,   NO_ITEM,		TACKLE, FORESIGHT, PECK, NO_MOVE
	db	10, PIDGEOTTO,	NO_ITEM,		TACKLE, MUD_SLAP, GUST, NO_MOVE
	db  12, MURKROW,  SHARP_BEAK,		PECK, PURSUIT, MUD_SLAP, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 23, CLEFAIRY,	NO_ITEM,		DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 23, FURRET,		NO_ITEM,		DEFENSE_CURL, FURY_SWIPES, ENDURE,	RETURN
	db 24, TEDDIURSA,	PINK_BOW,		FURY_SWIPES, FAINT_ATTACK, REST, SNORE
	db 26, MILTANK,    	NO_ITEM,		ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 18, LEDYBA,    	NO_ITEM,	TACKLE, SUPERSONIC, COMET_PUNCH, NO_MOVE
	db 18, SPINARAK,  	NO_ITEM,	POISON_STING, STRING_SHOT, NIGHT_SHADE, NO_MOVE
	db 19, YANMA,		NO_ITEM,	QUICK_ATTACK, DOUBLE_TEAM, SONICBOOM, NO_MOVE
	db 20, SCYTHER,    	SILVERPOWDER,	QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 30, HAUNTER,		NO_ITEM,	HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 32, MISDREAVUS,	NO_ITEM,	PSYWAVE, CONFUSE_RAY, SPITE, TOXIC
	db 35, GENGAR,     	NO_ITEM,	HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 34, HAUNTER,    	SPELL_TAG,	SHADOW_BALL, MEAN_LOOK, HYPNOSIS, NIGHT_SHADE
	db -1 ; end
...
YoungsterGroup:
	...
	; YOUNGSTER (7)
	db "JOEY@", TRAINERTYPE_ITEM
	db 15, RATTATA, PINK_BOW
	db -1 ; end

	; YOUNGSTER (8)
	db "JOEY@", TRAINERTYPE_ITEM_MOVES
	db 21, RATICATE,   PINK_BOW,	TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_ITEM_MOVES
	db 30, RATICATE,   PINK_BOW,	TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_ITEM_MOVES
	db 37, RATICATE,   PINK_BOW,	HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 24, BEEDRILL, FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 25, LEDIAN,	   COMET_PUNCH, SUPERSONIC, HEADBUTT, REFLECT
	...
	db 30, BEEDRILL,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 32, LEDIAN,		HEADBUTT, TOXIC, GIGA_DRAIN, SWAGGER
...
PicnickerGroup:
	...
	db 37, NIDOKING,   EARTHQUAKE, DOUBLE_KICK, POISON_STING, IRON_TAIL
	db 37, NIDOQUEEN,  EARTHQUAKE, DOUBLE_KICK, TAIL_WHIP, BODY_SLAM
	db -1 ; end
